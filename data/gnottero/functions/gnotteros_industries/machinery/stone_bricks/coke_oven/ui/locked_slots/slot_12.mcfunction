# Save all the data of the irregular item in the "gnottero:gnotteros_industries/coke_oven" and put back the right item
    ...
    replaceitem block ~ ~ ~ container.12 black_stained_glass_pane{ctc: {from: "gnotteros_industries", traits: ["item", "placeholder", "item/locked_placeholder"], id: "locked_placeholder"}, CustomModelData: 1280006, display: {Name: '{"text":""}'}}
