# Save all the data of the irregular item in the "gnottero:gnotteros_industries/coke_oven" and put back the right item
    ...
    replaceitem block ~ ~ ~ container.16 black_stained_glass_pane{ctc: {from: "gnotteros_industries", traits: ["item", "placeholder", "item/creosote_placeholder"], id: "creosote_placeholder"}, CustomModelData: 1280006, display: {Lore: ['[{"text":"Creosote:","italic":false,"color":"gray"},{"text":""}]'], Name: '{"text":"Stored Creosote","italic":false}'}}
